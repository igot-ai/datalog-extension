...
export class DatalogClient {
    ...
    async uploadFile(projectName: string, collectionName: string, filePath: string, transform: boolean = true): Promise<any> {
    ...
    async uploadPlainText(projectName: string, collectionName: string, text: string, transform: boolean = true): Promise<any> {
        const form = new FormData();
